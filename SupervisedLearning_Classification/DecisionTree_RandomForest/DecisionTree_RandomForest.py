...
y1_pred_dt_train = dt1.predict(X1_train)
y1_pred_dt = dt1.predict(X1_test)

print(">> Training Set Performance:")
print(f"Train Accuracy: {accuracy_score(y1_train, y1_pred_dt_train):.4f}")
print("\nClassification Report (Train):")
print(classification_report(y1_train, y1_pred_dt_train))
print("Confusion Matrix (Train):")
print(confusion_matrix(y1_train, y1_pred_dt_train))
...
y2_pred_dt_train = dt2.predict(X2_train)
y2_pred_dt = dt2.predict(X2_test)

print(">> Training Set Performance:")
print(f"Train Accuracy: {accuracy_score(y2_train, y2_pred_dt_train):.4f}")
print("\nClassification Report (Train):")
print(classification_report(y2_train, y2_pred_dt_train))
print("Confusion Matrix (Train):")
print(confusion_matrix(y2_train, y2_pred_dt_train))
...
y1_pred_rf_train = rf1.predict(X1_train)
y1_pred_rf = rf1.predict(X1_test)

print(">> Training Set Performance:")
print(f"Train Accuracy: {accuracy_score(y1_train, y1_pred_rf_train):.4f}")
print("\nClassification Report (Train):")
print(classification_report(y1_train, y1_pred_rf_train))
print("Confusion Matrix (Train):")
print(confusion_matrix(y1_train, y1_pred_rf_train))
...
y2_pred_rf_train = rf2.predict(X2_train)
y2_pred_rf = rf2.predict(X2_test)

print(">> Training Set Performance:")
print(f"Train Accuracy: {accuracy_score(y2_train, y2_pred_rf_train):.4f}")
print("\nClassification Report (Train):")
print(classification_report(y2_train, y2_pred_rf_train))
print("Confusion Matrix (Train):")
print(confusion_matrix(y2_train, y2_pred_rf_train))
...
print("-"*54)
print(f"{'Decision Tree':<20} {'1':<10} {accuracy_score(y1_train, y1_pred_dt_train):<12.4f} {accuracy_score(y1_test, y1_pred_dt):<12.4f}")
print(f"{'Decision Tree':<20} {'2':<10} {accuracy_score(y2_train, y2_pred_dt_train):<12.4f} {accuracy_score(y2_test, y2_pred_dt):<12.4f}")
print(f"{'Random Forest':<20} {'1':<10} {accuracy_score(y1_train, y1_pred_rf_train):<12.4f} {accuracy_score(y1_test, y1_pred_rf):<12.4f}")
print(f"{'Random Forest':<20} {'2':<10} {accuracy_score(y2_train, y2_pred_rf_train):<12.4f} {accuracy_score(y2_test, y2_pred_rf):<12.4f}")
